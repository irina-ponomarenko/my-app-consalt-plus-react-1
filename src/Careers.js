                    ...
                    <form className="job-form-wrapper">
                        ...
                        <div className="apply-wrapper">
                            <div className="wrapper-account">
                                ...
                                <div className="location">
                                    <label for="local-1"><span className="icon-location-pin"></span>Location :</label>
                        ...
                        <div className="apply-wrapper">
                            <div className="wrapper-account">
                                ...
                                <div className="location">
                                    <label for="local-3"><span className="icon-location-pin"></span>Location :</label>
                        ...
                        <div className="apply-wrapper">
                            <div className="wrapper-account">
                                ...
                                <div className="location">
                                    <label for="local-4"><span className="icon-location-pin"></span>Location :</label>
                        ...
                        <button type="submit" id="applic" className="btn-back application">Submit application</button>
                    </form>
                </div>
            </section>
