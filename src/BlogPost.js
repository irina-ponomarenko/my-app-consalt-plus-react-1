                        ...
                        <img className="card-img-top" src="images/blog-post.jpg" alt="Card image cap"/>
                            <div className="card-body">
                                ...
                                <ul className="list-card-blog">
                                    <li> <i className="fa fa-check" aria-hidden="true"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
                                    <li><i className="fa fa-check" aria-hidden="true"></i>Proin tempus ipsum vitae velit convallis venenatis.</li>
                                    <li><i className="fa fa-check" aria-hidden="true"></i>Curabitur vel felis pretium, blandit arcu in, sollicitudin ipsum.</li>
                                </ul>
                            </div>
